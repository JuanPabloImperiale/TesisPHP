...
$fechaTicket = $_SESSION["fechaTicket"];
$horacreacion = $_SESSION["horacreacion"];
$minutocreacion = $_SESSION["minutocreacion"];
?>
  <!DOCTYPE html>
               ...
               <div class="row">
                <div class="grid_12">
                  ...
                  <div>
                  	...
                  	<h2 align="center">  <font face="Gotham, Helvetica Neue, Helvetica, Arial, sans-serif">Ticket Digital</font></h2>
                    ...
                    <form action="guarda_ticket.php" id="nuevoticket" name="nuevoticket" method="POST">
                     <blockquote class="bq1"> 
                      ...
                      <h5 align="center"><font face="Gotham, Helvetica Neue, Helvetica, Arial, sans-serif">
                        ...
                        <?php echo ("<strong>Fecha:</strong> ".$_SESSION["fechaTicket"]); echo " <br>  "; ?>
                        ...
                        <?php echo ("<strong>Costo de Ticket:</strong> $".$_SESSION["costo"]); echo " <br>  "; ?>
                  ...
                  <div align="center">
                   ...
                   <a href ="./index.html"> <input type="button" class="btn" value="Inicio" > </a>
                 </div>
