              ...
              <div class="container">
                <div class="row">
                  <div class="grid_12">
                    <br><br>
                    <div>
                      <h2 align="center">  <font face="Gotham, Helvetica Neue, Helvetica, Arial, sans-serif">Reporte de: <?php echo ($administrador); echo " <br>  "; echo("Patente: ".$patente) ;?></font></h2>
                      <div id="contact-form">
                        <form id="formularioReporte" method="POST" action="enviarReporte.php">
